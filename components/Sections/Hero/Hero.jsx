...
const Hero = () => {
  return (
    ...
    >
      <div className="mb-[150px] flex h-auto w-full max-w-[1200px] flex-col-reverse items-center avg:mb-[150px] avg:flex-row avg:justify-around lg:mb-[180px]">
        <Image
          src={passport}
          alt="passport"
        ...
        <div className="flex-column-start mt-[40px] max-w-[560px] gap-[30px]">
          <h1 className="font-Petrona text-[4.2rem] font-medium leading-[120%] text-black md:text-[5.6rem] lg:text-[7rem]">
            Make Spain Your
            <br />
            <bold className="font-Petrona text-[4.6rem] font-bold leading-[120%] text-black md:text-[5.6rem] lg:text-[7rem]">
              Home Office
            </bold>
          </h1>
